...
> Direct-open boundary: sdlc-os evaluation harness documentation only. This file does not authorize model routing changes, evaluation execution, provider calls, plugin mutation, cleanup, external action, or instruction changes.
