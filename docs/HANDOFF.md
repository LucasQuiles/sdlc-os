...
**2,146 records** across 10 namespaces. Use `mcp__plugin_pinecone_pinecone__search-records` with namespace specified (NOT empty string — use specific namespace name).
