...
description: "Convention compliance auditor — checks runner output against the Convention Map (naming, file locations, styling, structure); runs in the L1 sentinel loop."
model: sonnet
---
